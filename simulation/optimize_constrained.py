...
Security constraints: Mechanical PRIMARY, Voice LIMITED
"""
import pandas as pd
import numpy as np
import os
...
W_M_MIN = 0.40  # Mechanical MUST be primary (≥40%)
W_G_MIN = 0.20  # Gap minimum
W_V_MAX = 0.25  # Voice CAPPED (replay vulnerability)
...
# Coarse grid
TAU_V_RANGE = range(20, 80, 10)
TAU_G_RANGE = range(20, 80, 10)
TAU_M_RANGE = range(40, 80, 10)
TAU_T_RANGE = range(50, 80, 5)
